...
export const copy = {
  ...
  procedimientos: {
    newButton:      'Nuevo procedimiento',
    editButton:     'Editar',
    archiveButton:  'Archivar',
    restoreButton:  'Restaurar',
    backToList:     'Volver a Procedimientos',
    openFile:       'Abrir archivo',
    downloadFile:   'Descargar archivo',
    nuevoBadge:     'Nuevo',
    archivadoBadge: 'Archivado',
    search: {
      placeholder:      'Buscar por título o categoría...',
      categoriaLabel:   'Categoría',
      categoriaTodas:   'Todas las categorías',
      mostrarArchivados:'Mostrar archivados',
    },
    emptyState: {
      adminSinResultados:  'No se encontraron procedimientos con ese filtro.',
      adminSinNinguno:     'Todavía no cargaste ningún procedimiento.',
      noAdminSinResultados:'No se encontraron procedimientos con ese filtro.',
      noAdminSinNinguno:   'Todavía no hay procedimientos publicados.',
    },
    table: {
      titulo:        'Título',
      categoria:     'Categoría',
    ...
    view: {
      ...
      actualizadoPorLabel: 'Actualizado por',
      sinCategoria:      'Sin categoría',
      archivadoAviso:    'Este procedimiento está archivado. Los empleados y supervisores no lo ven.',
      cargandoArchivo:   'Generando el enlace de descarga...',
      archivoNoDisponible: 'No se pudo generar el enlace de descarga.',
    },
    form: {
      crearTitle:     'Nuevo procedimiento',
      editarTitle:    'Editar procedimiento',
      titulo:         'Título',
      tituloPlaceholder: 'Ej. Protocolo de izaje de pala',
      categoria:      'Categoría',
      categoriaPlaceholder: 'Ej. Seguridad (elegí una existente o escribí una nueva)',
      tipoContenido:  'Contenido',
      tipoTexto:      'Texto',
      tipoArchivo:    'Archivo',
      tipoContenidoHint: 'Elegí una sola forma: texto escrito en la app, o un archivo. No las dos.',
      contenidoTexto: 'Contenido',
      archivo:        'Archivo',
      archivoHintNuevo:    'PDF, Word (.doc/.docx) o texto plano (.txt), máximo 10 MB.',
      archivoHintExistente:'Dejalo vacío para conservar el archivo actual.',
      guardar:        'Guardar',
      guardando:      'Guardando...',
      cancelar:       'Cancelar',
    },
    ...
    confirmArchivar: {
      title:   '¿Archivar este procedimiento?',
      message: 'Va a dejar de verse para Supervisores y Empleados. No se borra: lo podés restaurar cuando quieras.',
      confirm: 'Archivar',
    },
    confirmRestaurar: {
      title:   '¿Restaurar este procedimiento?',
      message: 'Va a volver a verse para todos los roles.',
      confirm: 'Restaurar',
    },
    messages: {
      creado:      'Procedimiento creado.',
      actualizado: 'Procedimiento actualizado.',
      archivado:   'Procedimiento archivado.',
      restaurado:  'Procedimiento restaurado.',
    },
    errors: {
      tituloRequerido:        'El título es requerido.',
      contenidoExclusivo:     'Elegí texto o archivo, no los dos.',
      contenidoRequerido:     'Cargá el contenido en texto o subí un archivo.',
      archivoRequerido:       'Seleccioná un archivo para subir.',
      archivoDemasiadoGrande: 'El archivo excede el límite de 10 MB.',
      tipoArchivoNoPermitido: 'Tipo de archivo no permitido:',
      urlNoDisponible:        'No se pudo generar la URL de acceso.',
      cargaError:             'No se pudieron cargar los procedimientos. Intentá recargar la página.',
      noEncontrado:           'El procedimiento no existe o fue eliminado.',
      generic:                'No se pudo completar la operación. Intentá de nuevo.',
    },
  },
