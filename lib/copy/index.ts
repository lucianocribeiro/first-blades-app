...
export const copy = {
  ...
  emails: {
    ...
    ausenciaAprobada: {
      subject:     'Tu día de trámite fue aprobado — First Blades',
      saludo:      'Hola',
      intro:       'Tu solicitud de día de trámite fue revisada por Administración y fue aprobada.',
      fechaLabel:  'Fecha',
      accion:      'Ya podés verla reflejada en el Calendario del portal.',
      firma:       'Equipo First Blades',
    },
    ausenciaRechazada: {
      subject:     'Tu día de trámite fue rechazado — First Blades',
      saludo:      'Hola',
      intro:       'Tu solicitud de día de trámite fue revisada por Administración y fue rechazada.',
      fechaLabel:  'Fecha',
      motivoLabel: 'Motivo del rechazo',
