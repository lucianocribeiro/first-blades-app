...
-- rotation_groups. La RLS de rotation_groups/rotation_assignments en
-- 0001_init.sql ya coincide exactamente con la constitución §6 (admin
-- completo; supervisor+empleado solo SELECT con scope de equipo; sin
-- escritura no-admin) — no requiere ajuste.
--
