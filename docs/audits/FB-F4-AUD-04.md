...
- **Estado PR:** PR #23 esta abierto, no draft y sin conflictos de merge observados durante la re-auditoria. Checks verdes el 2026-07-27: integracion RLS, typecheck/lint/tests/build y Vercel.
